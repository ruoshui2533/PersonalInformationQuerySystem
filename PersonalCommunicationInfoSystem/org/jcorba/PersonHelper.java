...
{
  private static String  _id = "IDL:org/jcorba/Person:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (org.jcorba.PersonHelper.id (), "Person", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    org.jcorba.Person value = new org.jcorba.Person ();
